...
public class ToastUI : UI_Base
{
    ...
    public void SetInfo(string text, float duration, Define.EToastColor color, Define.EToastPosition position)
    {
        Show(text, duration, colors[(int)color], position);
    }

    private void Show(string text, float duration, Color color, Define.EToastPosition position)
    {
