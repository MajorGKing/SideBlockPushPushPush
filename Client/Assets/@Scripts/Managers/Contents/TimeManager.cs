...
public class TimeManager
{
    ...
    public void Init()
    {
        ...
        LoopTimeCheckRoutine().Forget();
    }

    private async UniTaskVoid LoopTimeCheckRoutine()
    {
        while (true)
        {
            await UniTask.Delay(TimeSpan.FromMinutes(_timeInterval));
            Managers.Game.PlayerTimeCheck().Forget();
        }
    }
